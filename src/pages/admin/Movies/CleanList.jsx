// src/pages/admin/Movies/CleanList.jsx
...
import { debounce } from '@utils/paginationUtils';
...
const CleanAdminMoviesPage = () => {
  ...
  }, [params.sortBy, params.sortOrder, setSort]);
...
export default CleanAdminMoviesPage;