// src/pages/admin/Users.jsx - Main Users page component
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { useToast } from '@contexts/ToastContext';
import { useGetAllUsers, useDeleteUser, useGetUserStats } from '@hooks/useUsers';
...
const UserStatistics = () => {
  const { data: stats, isLoading, error } = useGetUserStats();

  if (isLoading) return <LoadingSpinner />;
  if (error) return <div className="text-red-600">Failed to load statistics</div>;
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <p className="text-2xl font-semibold text-gray-900">{stats?.managerUsers || 0}</p>
